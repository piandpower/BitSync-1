...
public class FileSplitter
	...
	/**
	  ...
	  */
	public static void join(String baseFilename, String folderName)
		{
		int numberParts;
		try {
		...
		for (int part = 0; part < numberParts; part++)
			{
			BufferedInputStream in = new BufferedInputStream(new FileInputStream(folderName+"/"+baseFilename + ".chunk" + part));
